...
$obtem_user_id = get_current_user_id();
        ...
        // 'meta_key'         => '',
        // 'meta_value'       => '',
        'post_type'        => 'contas_a_receber',
        'post_status'      => 'private'
        // 'suppress_filters' => true,
    );

    $pegaposts = get_posts($contas_receber);
...
?>
   <tr>
      ...
      <td> 
      <p>
      <a class="btn btn-success btn-edt-exc" href="/contaspagar/?page=edit-creceber&id_conta=<?= $id_conta ?>" role="button">Editar</a>
      <a class="btn btn-danger btn-edt-exc" href="/contaspagar/?page=exclui-conta&id_conta=<?= $id_conta ?>" role="button">Excluir</a>      </p>
      </td>
    </tr>
